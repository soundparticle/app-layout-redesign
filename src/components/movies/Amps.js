  ...
  render() {
    ...
    return (
      ...
      <section>
        ...
        <div>
          <img className="Vox AC 30 Top Boost"></img>
        ...
        <div>
          <img className="Fender Bassman 50"></img>
        ...
        <div>
          <img className="Fender Deluxe Reverb"></img>
        ...
        <div>
          <img className="Marshall Superbass"></img>
